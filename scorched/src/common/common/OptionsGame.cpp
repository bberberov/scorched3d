...
OptionsGame::OptionsGame() :
	...
	scorePerMoney_(
		options_,
		"ScorePerMoney",
		"The amount of score awarded for 100 money units earned",
		0, 0, 0, 100, 2
	),
	scorePerAssist_(
		options_,
		"ScorePerAssist",
		"The amount of score awarded for each kill assist",
		0, 2, 0, 50, 1
	),
	scorePerKill_(
		options_,
		"ScorePerKill",
		"The amount of score awarded for each kill",
		0, 10, 0, 50, 1
	),
	scorePerResign_(
		options_,
		"ScorePerResign",
		"The amount of score awarded for each resign",
		0, 0, -50, 50, 1
	),
	scorePerSpectate_(
		options_,
		"ScorePerSpectate",
		"The amount of score awarded for each move to spectator (only when tank is still alive)",
		0, 0, -10, 50, 1
	),
	scoreWonForRound_(
		options_,
		"ScoreWonForRound",
		"The amount of score awarded for round won",
		0, 250, 0, 500, 10
	),
	scoreWonForLives_(
		options_,
	...
	skillForRound_(
		options_,
		"SkillForRound",
		"The amount of skill awarded for winning the round",
		0, 0, 0, 100, 5
	),
	skillForMatch_(
		options_,
		"SkillForMatch",
		"The amount of skill awarded for winning the match",
		0, 0, 0, 100, 5
	),
	skillForResign_(
		options_,
		"SkillForResign",
		"The amount of skill awarded for resigning",
		0, 0, -50, 50, 5
	),
	maxSkillLost_(
		options_,
		"MaxSkillLost",
		"The maximum amount of skill you can lose for being killed",
		0, 10, 0, 100, 5
	),
	maxSkillGained_(
		options_,
		"MaxSkillGained",
		"The maximum amount of skill you can gain for killing someone",
		0, 10, 0, 100, 5
	),
	skillForSelfKill_(
		options_,
		"SkillForSelfKill",
		"The amount of skill you lose for being killed by yourself",
		0, -25, -50, 0, 5
	),
	skillForTeamKill_(
		options_,
	...
	startArmsLevel_(
		options_,
		"StartArmsLevel",
		"The largest weapon type allowed (on round 1)",
		0, 10, 0, 10, 1
	),
	endArmsLevel_(
		options_,
		"EndArmsLevel",
		"The largest weapon type allowed (on the last round)",
		0, 10, 0, 10, 1
	),
	maxNumberWeapons_(
		options_,
	...
	aiShotTime_(
		options_,
		"AIShotTime",
		"The amount of time each computer controller player has for each shot",
		0, 10, 0, 90, 2
	),
	buyingTime_(
		options_,
	...
	minFallingDistance_(
		options_,
		"MinFallingDistance",
		"The minimum distance that can be made with no damage (value is divided by 10)",
		0, 5, 0, 100, 5
	),
	tankFallingDamage_(
		options_,
		"TankFallingDamage",
		"If tanks tank damage from falling",
		0, true
	),
	maxClimbingDistance_(
		options_,
		"MaxClimbingDistance",
	...
	teamBallance_(
		options_,
		"TeamBallance",
		"The mode of team auto-ballancing performed for team games",
		0, int(TeamBallanceNone), teamBallanceEnum
	),
	turnType_(
		options_,
		"TurnType",
	...
	moneyWonForRound_(
		...
		0, 5000, 0, 100000, 1000
	),
	moneyWonForLives_(
		options_,
		"MoneyWonForLives",
		"The money awarded for each life remaining",
		0, 5000, 0, 100000, 1000
	),
	moneyPerKillPoint_(
		options_,
		"MoneyWonPerKillPoint",
		"The money awarded for each person killed * weapon used",
		0, 750, 0, 2000, 50
	),
	moneyPerMultiKillPoint_(
		options_,
		"MoneyWonPerMultiKillPoint",
		"The extra money awarded for each person multi-killed * weapon used * multi-kill",
		0, 0, 0, 2000, 50
	),
	moneyPerAssistPoint_(
		options_,
		"MoneyWonPerAssistPoint",
		"The money awarded for each kill assist * weapon used",
		0, 250, 0, 2000, 50
	),
	moneyPerHitPoint_(
		options_,
	...
	moneyPerRound_(
		options_,
		"MoneyPerRound",
		"The money given at the end of each round",
		0, 0, 0, 250000, 5000
	),
	moneyPerHealthPoint_(
		options_,
		"MoneyPerHealthPoint",
	...
	freeMarketAdjustment_(
		options_,
		"FreeMarketAdjustment",
		"The scale of the adjustment changes made by the free market",
		0, 100
	),
	freeMarketLimits_(
		options_,
		"FreeMarketLimits",
		"The scale of the max/min prices (*1.5) allowed by the free market e.g. 2 is a 300% increase/reduction",
		0, 2
	),
	freeMarketTracksBotPurchases_(
		options_,
		"FreeMarketTrackBotPurchases",
	...
	mod_(
		options_,
		"Mod",
		"The name of currently running Scorched3D mod",
		0, "none"
	),
	motd_(
		options_,
	...
	registeredUserNames_(
		options_,
		"RegisteredUserNames",
		"Only allow authenticated players to use their own player names",
		0, false
	),
	allowMultiLingualChat_(
		options_,
		"AllowMultiLingualChat",
		"Allow internaltional (non-latin) characters in chat",
		0, true
	),
	allowMultiLingualNames_(
		options_,
		"AllowMultiLingualNames",
		"Allow internaltional (non-latin) characters in names",
		0, true
	),
	authHandler_(
		options_,
		"AuthHandler",
		"Only allow authenticated players to connect",
		0, "none", authHandlerEnum
	),
	authHandlerParam1_(
		options_,
		"AuthHandlerParam1",
		"First parameter for the authentication handler",
		0, ""
	),
	authHandlerParam2_(
		options_,
	...
	depricatedMasterListServer_(
		...
		OptionEntry::DataDepricated, "scorched3d.sourceforge.net"
	),
	depricatedMasterListServerURI_(
		options_,
		"MasterListServerURI",
		"The URI on the master list server for scorched3d",
		OptionEntry::DataDepricated, "/scorched"
	),
	depricatedServerAdminPassword_(
		options_,
		"ServerAdminPassword",
		"The admin password for this server (empty password is no access)",
		OptionEntry::DataDepricated, ""
	),
	depricatedMaxArmsLevel_(
		options_,
		"MaxArmsLevel",
		"",
...
bool OptionsGame::writeToBuffer(NetBuffer &buffer, bool useProtected, bool usePlayerTypes)
{
...
bool OptionsGame::readFromBuffer(NetBufferReader &reader, bool useProtected, bool usePlayerTypes)
{
	std::list<OptionEntry *> saveOptions;
	if (usePlayerTypes) saveOptions = playerTypeOptions_;
	std::list<OptionEntry *>::iterator itor;
...
{
	std::list<OptionEntry *> saveOptions = playerTypeOptions_; // Note: The players are also saved
	std::list<OptionEntry *>::iterator itor;
	for (itor = options_.begin();
		itor != options_.end();
		++itor)
