...
OptionsDisplay::OptionsDisplay() :
	...
	onlineUserName_(
		options_,
		"OnlineUserName",
		"The player name that will be used for all online games.",
		RAccess | NoRestore, "Player"
	),
	onlineTankModel_(
		options_,
		"OnlineTankModel",
		"The tank model that will be used for all online games.",
		RAccess | NoRestore, ""
	),
	onlineColor_(
		options_,
	...
	dialogSize_(
		options_,
		"DialogSize",
		"How large the on screen dialogs and menus are.",
		RAccess, 2, 0, 3, 1
	),
	tankModelSize_(
		options_,
	...
	toolTipTime_(
		options_,
		"ToolTipTime",
		"The milliseconds before showing a tool tip.",
		RWAccess, 100
	),
	toolTipSpeed_(
		options_,
	...
	brightness_(
		options_,
		"Brightness",
		"The game screen brightness (gamma).",
		RAccess, 10, 3, 40, 1
	),
	fullScreen_(
		options_,
		"FullScreen",
		"Run the game in a full screen mode.",
		RAccess | NoRestore, false
	),
	moreRes_(
		options_,
		"MoreRes",
	...
	invertElevation_(
		options_,
		"InvertUpDownKeys",
		"Invert/reverse the tanks up/down elevation directions.",
		RWAccess | NoRestore, false
	),
	invertMouse_(
		options_,
	...
	swapYAxis_(
		options_,
		"SwapYAxis",
		"Remaps mouse pointer from top of window to the bottom and vice-versa (MAC/OSX)",
		RWAccess | NoRestore, false
	),
	sideScroll_(
		options_,
	...
	noGLTexSubImage_(
		options_,
		"NoGLTexSubImage",
		"Do not use texture area replacing.  Required to be able to scorch the ground.",
		RAccess, false
	),
	noGLShaders_(
		options_,
	...
	noGLExt_(
		options_,
		"NoGLExt",
		"Do not use any OpenGL extensions.  Turn off to disable any extra OpenGL features.",
		RAccess, false
	),
	noGLMultiTex_(
		options_,
	...
	noThreadedDraw_(
		options_,
		"NoThreadedDraw",
		"Don't calculate landscape in another thread",
		RWAccess, false
	),
	noGLEnvCombine_(
		options_,
		"NoGLEnvCombine",
		"Only use one texture on the landscape.",
		RAccess, false
	),
	noGLCubeMap_(
		options_,
		"NoGLCubeMap",
		"Draw the water without using cubemap relfections.",
		RAccess, false
	),
	noGLSphereMap_(
		options_,
		"NoGLSphereMap",
		"Draw the water without using sphere map relfections.",
		RAccess, false
	),
	noGLDrawElements_(
		options_,
		"NoGLDrawElements",
		"Draw grids without using draw elements.",
		RWAccess, false
	),
	noGLHardwareMipmaps_(
		options_,
		"NoGLHardwareMipmaps",
	...
	soundChannels_(
		options_,
		"SoundChannels",
		"Number of sound channels to mix.",
		RAccess, 8
	),
	noCountDownSound_(
		options_,
		"NoCountDownSound",
		"Do not play the count down beep sound.",
		RWAccess, false
	),
	noChannelTextSound_(
		options_,
		"NoChannelTextSound",
		"Do not play the channel text being added sound.",
		RWAccess, false
	),
	noSound_(
		options_,
	...
	noObjectReflections_(
		options_,
		"NoObjectReflections",
		"Do not draw the reflections of objects.",
		RWAccess, true
	),
	noParticleReflections_(
		options_,
		"NoParticleReflections",
	...
	noSimulateParticles_(
		options_,
		"NoParticleSimulate",
		"Do not use custom simulations for the  particles.",
		RWAccess, false
	),
	noDrawParticles_(
		options_,
		"NoParticleDraw",
		"Do not draw any particles.",
		RWAccess, false
	),
	noTrees_(
		options_,
		"NoTrees",
		"Do not draw any trees",
		RWAccess, false
	),
	noTargets_(
		options_,
		"NoTargets",
		"Do not draw any targets/tanks (non-trees)",
		RWAccess, false
	),
	lowTreeDetail_(
		options_,
	...
	drawLines_(
		options_,
		"DrawLines",
		"Do not fill in the landscape",
		DebugOnly | RWAccess, false
	),
	drawLandLOD_(
		options_,
		"DrawLandLOD",
		"Show the LOD levels and indices of the land patches",
		DebugOnly | RWAccess, false
	),
	drawNormals_(
		options_,
		"DrawNormals",
		"Show landscape normals on the landscape",
		RWAccess, false
	),
	drawGraphicalShadowMap_(
		options_,
		"DrawGraphicalShadowMap",
		"Shows the depth map used for shadowing",
		RWAccess, false
	),
	drawGraphicalReflectionMap_(
		options_,
	...
	drawCollisionGeoms_(
		options_,
		"DrawCollisionGeoms",
		"Show object collision geoms",
		DebugOnly | RWAccess, false
	),
	drawCollisionSpace_(
		options_,
		"DrawCollisionSpace",
		"Show object collision space",
		DebugOnly | RWAccess, false
	),
	drawBoundingSpheres_(
		options_,
		"DrawBoundingSpheres",
	...
	noWaterMovement_(
		options_,
		"NoWaterMovement",
		"Draw simpler less detailed water",
		RWAccess, false
	),
	noWaterReflections_(
		options_,
		"NoWaterReflections",
		"Draw reflections in the water",
		RWAccess, false
	),
	noWaterWaves_(
		options_,
		"NoWaterWaves",
		"Draw water waves (breakers)",
		RWAccess, false
	),
	noWaterLOD_(
		options_,
		"NoWaterLOD",
		"Draw water at minimum detail",
		RWAccess, false
	),
	noLandLOD_(
		options_,
		"NoLandLOD",
		"Draw water at MAXIMUM detail",
		RWAccess, false
	),
	noSkyLayers_(
		options_,
		"NoSkyLayers",
		"Only draw one sky layer.",
		RWAccess, false
	),
	noSkyMovement_(
		options_,
	...
	depricatedNoModelLOD_(
		options_,
		"NoModelLOD",
		"Do not use LOD optimizations for models",
		OptionEntry::DataDepricated, true
	),
	noModelLighting_(
		options_,
		"NoModelLighting",
		"Do not use dynamic lighting calculations for models",
		RWAccess, false
	),
	...
	tankDetail_(
		options_,
		"TankDetail",
		"The tank details setting.  Lower is faster but shows less tank models.",
		RAccess, 2, 0, 2, 1
	),
	effectsDetail_(
		options_,
		"EffectsDetail",
		"The number of effects allowed at once.",
		RAccess, 1, 0, 2, 1
	),
	deformRecalculationTime_(
		options_,
		"DeformRecalculationTime",
	...
	focusPause_(
		options_,
		"FocusPause",
		"Pause the graphics display when mouse leaves window.",
		RWAccess, true
	),
	openGLWarnings_(
		options_,
