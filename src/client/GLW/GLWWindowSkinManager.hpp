...
#ifndef __INCLUDE_GLWWindowSkinManager_hpp_INCLUDE__
#define __INCLUDE_GLWWindowSkinManager_hpp_INCLUDE__
...
#endif  // __INCLUDE_GLWWindowSkinManager_hpp_INCLUDE__
