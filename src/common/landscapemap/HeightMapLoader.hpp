...
#ifndef __INCLUDE_HeightMapLoader_hpp_INCLUDE__
#define __INCLUDE_HeightMapLoader_hpp_INCLUDE__
...
{
	void loadTerrain( HeightMap& hmap, Image& image, bool levelSurround, ProgressCounter* counter = nullptr );
