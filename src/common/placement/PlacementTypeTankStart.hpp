...
#ifndef __INCLUDE_PlacementTypeTankStart_hpp_INCLUDE__
#define __INCLUDE_PlacementTypeTankStart_hpp_INCLUDE__
...
#endif  // __INCLUDE_PlacementTypeTankStart_hpp_INCLUDE__
