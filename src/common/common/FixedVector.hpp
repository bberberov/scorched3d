...
#ifndef __INCLUDE_FixedVector_hpp_INCLUDE__
#define __INCLUDE_FixedVector_hpp_INCLUDE__
...
public:
	...
	fixed Max() { return MAX( V[0], MAX( V[1], V[2] ) ); }
	...
	void operator-=( const fixed a ) { ( *this ) += -fixed( a ); }
	...
	bool operator!=( const FixedVector& Vin1 ) { return ! ( ( *this ) == Vin1 ); }
...
#endif  // __INCLUDE_FixedVector_hpp_INCLUDE__
