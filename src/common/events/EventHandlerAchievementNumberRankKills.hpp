...
#ifndef __INCLUDE_EventHandlerAchievementNumberRankKills_hpp_INCLUDE__
#define __INCLUDE_EventHandlerAchievementNumberRankKills_hpp_INCLUDE__

#include <events/EventHandlerAchievementNumberRank.hpp>
