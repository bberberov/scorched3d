...
static void createMainControls(wxWindow *parent, wxSizer *sizer)
{
	...
	IDC_SLIDER1_CTRL         = new wxSlider(parent, -1, 0, 0, 0, wxDefaultPosition, wxSize(315, -1), wxSL_HORIZONTAL | wxSL_AUTOTICKS);
	IDC_MORERES_CTRL         = new wxCheckBox(parent, ID_MORERES, wxT("More Resolutions"));
	...
	IDC_TINYDIALOGS_CTRL         = new wxRadioButton(parent, -1, wxT("Tiny"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
	...
	IDC_FRAMELIMIT_CTRL          = new wxTextCtrl(   parent, -1, wxString(), wxDefaultPosition, wxSize(60, -1));
	...
	IDC_AMBIENTVOLUME_CTRL          = new wxSlider(parent, -1, 0, 0, 0, wxDefaultPosition, wxSize(315, -1), wxSL_HORIZONTAL | wxSL_AUTOTICKS);
	IDC_NOSOUND_CTRL                = new wxCheckBox(parent, -1, wxT("No Sound"));
	...
	IDC_MUSICVOLUME_CTRL            = new wxSlider(parent, -1, 0, 0, 0, wxDefaultPosition, wxSize(315, -1), wxSL_HORIZONTAL | wxSL_AUTOTICKS);
	IDC_NOMUSIC_CTRL                = new wxCheckBox(parent, -1, wxT("No Music"));
	...
	loadSizer->Add(
		new wxStaticText(parent, -1,
			wxT("Use ultra detail settings for Scorched3D. (For V FAST machines)")
		), 0, wxALL, 2
	);
	loadSizer->Add(IDC_LOADDEFAULTS_CTRL, 0, wxALL, 2);
	loadSizer->Add(
		new wxStaticText(parent, -1,
			wxT("Use normal detail settings for Scorched3D. (For FAST machines)")
		), 0, wxALL, 2
	);
	...
	loadSizer->Add(
		new wxStaticText(parent, -1,
			wxT(
				"Use faster detail settings for Scorched3D. (For MEDIUM machines)\n"
	...
	loadSizer->Add(
		new wxStaticText(parent, -1,
			wxT(
				"Use fastest detail settings for Scorched3D. (For SLOW machines)\n"
	...
	loadSizer->Add(
		new wxStaticText(parent, -1,
			wxT(
				"Use safest settings for Scorched3D.\n"
...
static void createOtherControls(wxWindow *parent, wxSizer *sizer)
{
	{
	// Misc switches
	wxStaticBox *miscBox = new wxStaticBox(parent, -1, wxT("Misc. Options"));
	wxStaticBoxSizer *miscSizer = new wxStaticBoxSizer(miscBox, wxHORIZONTAL);

	wxGridSizer *miscSizer2 = new wxGridSizer(3, 3, 10, 10);

	IDC_INVERT_CTRL         = new wxCheckBox(parent, -1, wxT("Invert key elevation"));
	miscSizer2->Add(IDC_INVERT_CTRL,         0);
	IDC_INVERTMOUSE_CTRL    = new wxCheckBox(parent, -1, wxT("Invert mouse elevation"));
	miscSizer2->Add(IDC_INVERTMOUSE_CTRL,    0);
	// IDC_SWAPYAXIS_CTRL   = new wxCheckBox(parent, -1, wxT("Invert mouse y axis (OS X)"));
	// miscSizer2->Add(IDC_SWAPYAXIS_CTRL,   0);
	IDC_TIMER_CTRL          = new wxCheckBox(parent, -1, wxT("Show frames per second"));
	miscSizer2->Add(IDC_TIMER_CTRL,          0);
	IDC_SMOUSE_CTRL         = new wxCheckBox(parent, -1, wxT("Software Mouse"));
	miscSizer2->Add(IDC_SMOUSE_CTRL,         0);
	IDC_VALIDATESERVER_CTRL = new wxCheckBox(parent, -1, wxT("Validate Server Ip"));
	miscSizer2->Add(IDC_VALIDATESERVER_CTRL, 0);
	IDC_SIDESCROLL_CTRL     = new wxCheckBox(parent, -1, wxT("Side Scrolling"));
	miscSizer2->Add(IDC_SIDESCROLL_CTRL,     0);
	IDC_PLAYERCAMERA_CTRL   = new wxCheckBox(parent, -1, wxT("Remember camera pos"));
	miscSizer2->Add(IDC_PLAYERCAMERA_CTRL,   0);
	IDC_LOGGING_CTRL        = new wxCheckBox(parent, -1, wxT("Client Logging"));
...
static void createSpeedControls(wxWindow *parent, wxSizer *sizer)
{
	...
	IDC_LANDLOD_CTRL = new wxSlider(parent, -1, 0, 0, 0, wxDefaultPosition, wxSize(315, -1), wxSL_HORIZONTAL | wxSL_AUTOTICKS);
	...
	// Detail switches
	{
	wxStaticBox *waterDetailBox = new wxStaticBox(parent, -1, wxT("Graphics Detail"));
	...
	IDC_NOWATERREF_CTRL =            new wxCheckBox(parent, -1, wxT("Don't draw water reflections - Large Framerate Improvement"));
	IDC_NOWATERMOVEMENT_CTRL       = new wxCheckBox(parent, -1, wxT("Don't draw water movement - Large Framerate Improvement"));
	IDC_NOWATER_CTRL               = new wxCheckBox(parent, -1, wxT("Don't draw water - Large Framerate Improvement"));
	IDC_NOWATERWAVES_CTRL          = new wxCheckBox(parent, -1, wxT("Don't draw water breakers - Small Loading Speed Improvement"));
	IDC_NOWATERLOD_CTRL            = new wxCheckBox(parent, -1, wxT("Draw simplistic water - Medium Framerate Improvement"));
	IDC_NOSHADERS_CTRL             = new wxCheckBox(parent, -1, wxT("No GL shaders - Large Framerate Improvement"));
	IDC_SIMPLEWATERSHADERS_CTRL    = new wxCheckBox(parent, -1, wxT("Simple water shaders - Medium Framerate Improvement"));
	IDC_NOOBJECTSHADOWS_CTRL       = new wxCheckBox(parent, -1, wxT("No GL shadows for objects - Medium Framerate Improvement"));
	IDC_NOOBJECTREFLECTIONS_CTRL   = new wxCheckBox(parent, -1, wxT("No water reflections for objects - Medium Framerate Improvement"));
	IDC_NOPARTICLEREFLECTIONS_CTRL = new wxCheckBox(parent, -1, wxT("No water reflections for particles - Small Framerate Improvement"));
	IDC_NOSHADOWS_CTRL             = new wxCheckBox(parent, -1, wxT("No GL shadows - Large Framerate Improvement"));
...
static void createTroubleControls(wxWindow *parent, wxSizer *sizer)
{
	// Graphics Settings
	{
	wxStaticBox *glDetailBox = new wxStaticBox(parent, -1, wxT("Compatibility Settings"));
	...
	IDC_NOEXT_CTRL             = new wxCheckBox(parent, -1, wxT("No GL Extensions"));
	IDC_NOMULTITEX_CTRL        = new wxCheckBox(parent, -1, wxT("No multi texture"));
	IDC_NOLANDSCAPESCORCH_CTRL = new wxCheckBox(parent, -1, wxT("No TexSubImaging"));
	IDC_NOENVCOMBINE_CTRL      = new wxCheckBox(parent, -1, wxT("No combined textures"));
	IDC_NOCUBEMAP_CTRL         = new wxCheckBox(parent, -1, wxT("No cube map"));
	IDC_NOSPHEREMAP_CTRL       = new wxCheckBox(parent, -1, wxT("No sphere map"));
	IDC_NOMIPMAPS_CTRL         = new wxCheckBox(parent, -1, wxT("No HW mip maps"));
	IDC_NOVBO_CTRL             = new wxCheckBox(parent, -1, wxT("No VBO"));
	...
	{
	wxStaticBox *miscDetailBox = new wxStaticBox(parent, -1, wxT("Misc Detail"));
	...
	IDC_NODETAILTEX_CTRL     = new wxCheckBox(parent, -1, wxT("Don't use detail textures"));
	IDC_NOSURROUND_CTRL      = new wxCheckBox(parent, -1, wxT("Don't draw surround"));
	IDC_SINGLESKYLAYER_CTRL  = new wxCheckBox(parent, -1, wxT("Single sky layer"));
	IDC_NOSKYANI_CTRL        = new wxCheckBox(parent, -1, wxT("Don't animate sky"));
	IDC_NOSKINS_CTRL         = new wxCheckBox(parent, -1, wxT("No model skins"));
	IDC_NODYNAMICLIGHT_CTRL  = new wxCheckBox(parent, -1, wxT("No model dynamic lighting"));
	IDC_NOPRECIPITATION_CTRL = new wxCheckBox(parent, -1, wxT("No precipitation"));
	IDC_NODEPTHSORT_CTRL     = new wxCheckBox(parent, -1, wxT("No sprite depth sorting"));
	IDC_NOBACKDROP_CTRL      = new wxCheckBox(parent, -1, wxT("No progress backdrop"));
...
{
	wxScrolledWindow *scrolledWindow = new wxScrolledWindow(parent, -1, wxDefaultPosition, wxSize(480, 250));
	...
	int lastGroup = 0;
	std::list<std::string> &keys = Keyboard::instance()->getKeyList();
	...
	for (itor = keys.begin(); itor != keys.end(); ++itor)
	{
		...
		if (key->getGroup() != lastGroup)
		{
			...
			{
				sizer->Add(new wxStaticText( scrolledWindow, -1, wxString("", wxConvUTF8) ), 0, wxALIGN_LEFT);
			}
		}

		// Add the key name
		wxStaticText *text = new wxStaticText(scrolledWindow, -1, wxString(key->getTitle(), wxConvUTF8));
		...
		{
			wxButton *button = new wxButton(scrolledWindow, ID_KEY, wxT(""), wxDefaultPosition, wxSize(120, -1));
...
static void updateModList()
{
	...
	if (dirs.loadModDirs())
	{
		...
		for (itor = dirs.getDirs().begin(); itor != dirs.getDirs().end(); ++itor)
		{
			ModInfo &info = (*itor);
