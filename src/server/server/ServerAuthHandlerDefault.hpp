...
#ifndef __INCLUDE_ServerAuthHandlerDefault_hpp_INCLUDE__
#define __INCLUDE_ServerAuthHandlerDefault_hpp_INCLUDE__
...
#endif  // __INCLUDE_ServerAuthHandlerDefault_hpp_INCLUDE__
