...
#ifndef __INCLUDE_ServerOperationResultHandler_hpp_INCLUDE__
#define __INCLUDE_ServerOperationResultHandler_hpp_INCLUDE__
...
#endif  // __INCLUDE_ServerOperationResultHandler_hpp_INCLUDE__
